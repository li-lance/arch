...
package com.fate.arch.viewbinding
...
@Deprecated(
    ...
    ReplaceWith("viewBinding(viewBinder)", "com.fate.arch.viewbinding.viewBindingActivity")
)
...
@Deprecated(
    "Use viewBinding delegate",
    ReplaceWith("viewBinding(vbFactory, viewProvider)", "com.fate.arch.viewbinding.viewBindingActivity")
)
...
@Deprecated(
    "Use viewBinding delegate",
    ReplaceWith("viewBinding(vbFactory, viewBindingRootId)", "com.fate.arch.viewbinding.viewBindingActivity"),
)
